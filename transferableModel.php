...
/*
  These things do nothing, they are supposed to
  make sure that the code using "transferableModel" stuff still works!
  (As I have no idea how to safely change the part of code
  which is in Typo3 plugins without the risk of
